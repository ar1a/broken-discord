{
  pkgs = hackage:
    {
      packages = {
        ...
        "authenticate-oauth".revision = (((hackage."authenticate-oauth")."1.6").revisions).default;
        ...
        "discord-haskell".revision = (((hackage."discord-haskell")."0.8.1").revisions).default;
        ...
        "http-api-data".revision = (((hackage."http-api-data")."0.3.10").revisions).default;
        "http-api-data".flags.use-text-show = false;
        "retry".revision = (((hackage."retry")."0.7.7.0").revisions).default;
        ...
        "req".revision = (((hackage."req")."1.1.0").revisions).default;
        "req".flags.dev = false;
        ...
        "wuss".revision = (((hackage."wuss")."1.1.12").revisions).default;
        ...
        "RSA".revision = (((hackage."RSA")."2.3.1").revisions).default;
  ...
  extras = hackage:
    { packages = { yeskell = ./.plan.nix/yeskell.nix; }; };
  }